                                    ...
                                    <div class="uk-navbar-dropdown uk-user-dropdown" id="user-dropdown">
                                        <ul class="uk-nav uk-navbar-dropdown-nav">
                                            ...
                                            @if( auth()->user()->onTrial() && !auth()->user()->subscription('main') )
                                                <li><a href="#"><span uk-icon="icon: cloud-upload"></span>Upgrade My Account</a></li>
                                            @endif
                                            @if(Voyager::can('browse_admin'))
                                                <li><a href="#"><span uk-icon="icon: bolt"></span>Admin</a></li>
                                            @endif
                                            <li><a href="#"><span uk-icon="icon: user"></span>My Profile</a></li>
                                            <li><a href="#"><span uk-icon="icon: cog"></span>Settings</a></li>
                                            <li class="uk-hidden@m"><a href="#"><span uk-icon="icon: bell"></span>My Notifications</a></li>
