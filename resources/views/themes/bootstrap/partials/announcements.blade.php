...
<div id="announcement" class="fadeIn" data-href="{{ route('wave.announcement', $announcement->id) }}">
	<div id="announcement_content">
		<span id="announcement_close">&times;</span>
		<h4>{{ $announcement->title }}</h4>
		<p>{{ $announcement->description }}</p>
		<div id="announcement_footer"><a href="{{ route('wave.announcement', $announcement->id) }}">Learn More</a></div>
	</div>
</div>
