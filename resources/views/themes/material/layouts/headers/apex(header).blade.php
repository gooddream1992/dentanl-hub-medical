                            ...
                            <li class="dropdown nav-item"><a id="dropdownBasic3" href="#" data-toggle="dropdown"
                                ...
                                <div class="dropdown-menu dropdown-menu-right text-left"><a href="javascript:;"
                                        class="dropdown-item py-1"><img
                                            src="{{ asset('themes/apex/img/flags/us.png') }}" class="langimg" /><span>
                                            English</span></a><a href="javascript:;" class="dropdown-item py-1"><img
                                            src="{{ asset('themes/apex/img/flags/es.png') }}" class="langimg" /><span>
                                            Spanish</span></a><a href="javascript:;" class="dropdown-item py-1"><img
                                            src="{{ asset('themes/apex/img/flags/br.png') }}" class="langimg" /><span>
                                            Portuguese</span></a><a href="javascript:;" class="dropdown-item"><img
                                            src="{{ asset('themes/apex/img/flags/de.png') }}" class="langimg" /><span>
                                            French</span></a></div>
                            </li>
                            ...
                            <li class="dropdown nav-item"><a id="dropdownBasic3" href="#" data-toggle="dropdown"
                                ...
                                <div ngbdropdownmenu="" aria-labelledby="dropdownBasic3"
                                    class="dropdown-menu text-left dropdown-menu-right"><a
                                        href="#" class="dropdown-item py-1"><i
                                            class="ft-message-square mr-2"></i><span>Chat</span></a><a
                                        href="{{ route('profile.edit') }}"
                                        class="dropdown-item py-1"><i class="ft-edit mr-2"></i><span>Edit
                                            Profile</span></a><a href="#"
                                        class="dropdown-item py-1"><i class="ft-mail mr-2"></i><span>My Inbox</span></a>
