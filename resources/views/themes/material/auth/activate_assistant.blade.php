@extends('theme::layouts.app', ['activePage' => 'registerpage for assistant', 'titlePage' => __('registerpage for
assistant')])
            ...
            <div uk-grid>
                ...
                <div class="uk-width-3-4 uk-align-center">
                    ...
                    <div class="uk-padding uk-box-shadow-large">
                        ...
                        @else
                        <h2>Activation for Assistant</h2>
                        @endif
                        ...
                        <div class="uk-grid-match uk-grid-small" uk-grid>
                            ...
                            <div class="uk-width-1-3@m">
                                ...
                                <input class="uk-input uk-form-width-medium" id="mobile_number" type="password"
