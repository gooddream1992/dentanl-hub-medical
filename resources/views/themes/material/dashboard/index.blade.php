...
<body data-col="2-columns" class=" 2-columns ">
                                    ...
                                    <div class="card-body">
                                        <div class="chart-info mb-2">
                                            ...
                                            <span class="text-uppercase"><i
                                                    class="fa fa-circle deep-purple font-small-2 mr-1"></i>
                                                Visits</span>
                                        </div>
    ...
    <script src="{{ asset('themes/apex/vendors/js/chartist.min.js')}}" type="text/javascript"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN APEX JS-->
    ...
    <!-- END APEX JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="{{ asset('themes/apex/js/dashboard1.js')}}" type="text/javascript"></script>
