                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @endforeach
                                            @canImpersonate
                                                <a href="{{url('admin/activatecode/'.$data->id) }}" class="btn btn-sm btn-warning pull-right" style="margin-right:5px; background:#09cd9f;">
                                                    <i class="voyager-people"></i> <span class="hidden-xs hidden-sm">Activation</span>
                                                </a>
                                            @endCanImpersonate
                                        </td>
                                    </tr>
