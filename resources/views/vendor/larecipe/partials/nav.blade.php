...
<larecipe-nav type="white" effect="light" expand fixed title="{{ config('app.name')}}" style="height: 4rem; top: 3px;">
    ...
    <div class="navbar-nav ml-lg-auto">
        ...
        @endif
         <larecipe-button tag="a" id="repository_button" target="_blank" href="{{ url('/') }}" slot="title" type="outline-primary" style="width: 100%">
            <i class="fa fa-external-link"></i> View My Site
        </larecipe-button>
        {{-- /repository link --}}
        ...
        @auth
            ...
            <larecipe-dropdown>
                ...
                <a class="dropdown-item" href="{{ route('wave.profile', Auth::user()->username) }}"><i class="fa fa-user"></i>  My Profile</a>
                <a class="dropdown-item" href="{{ route('wave.settings') }}"><i class="fa fa-cog"></i> Settings</a>
