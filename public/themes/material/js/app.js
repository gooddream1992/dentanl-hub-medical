...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_sticky_footer__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_sticky_footer___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_sticky_footer__);
...
window.onload = function () {
    __WEBPACK_IMPORTED_MODULE_2_sticky_footer___default.a.init();
};
...
if (confirmCancelBtn) {
    __WEBPACK_IMPORTED_MODULE_0_uikit___default.a.util.on('#confirm-cancel', 'click', function (e) {
        e.preventDefault();
        e.target.blur();
        __WEBPACK_IMPORTED_MODULE_0_uikit___default.a.modal.confirm(confirmCancelBtn.dataset.details, { labels: { ok: 'Yes, Cancel My Subscription', cancel: 'No Thanks' }, stack: true }).then(function () {
...
var hideBodyOverflow = function hideBodyOverflow() {
    document.body.classList.add('hide-overflow');
};

var showBodyOverflow = function showBodyOverflow() {
...
var mobileOptimizations = function mobileOptimizations() {
...
/* WEBPACK VAR INJECTION */(function(global) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! sticky-footer v4.2.0 | (c) 2016 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/sticky-footer */
